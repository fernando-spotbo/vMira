...
async function proxyRequest(
  ...
  const ALLOWED_PREFIXES = ["auth/", "chat/", "api-keys/", "sessions/", "admin/", "billing/", "attachments/", "voice/", "notifications", "reminders", "notification-settings", "telegram", "actions", "calendar", "live/", "organizations/", "code/"];
