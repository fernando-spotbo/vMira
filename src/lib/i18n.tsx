...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "settings.calendarFeed": { ru: "Подписка на календарь", en: "Calendar Subscription" },
  "settings.calendarFeedDesc": { ru: "Добавьте URL в любое приложение-календарь (Google, Apple, Outlook, Яндекс)", en: "Add this URL to any calendar app (Google, Apple, Outlook, Yandex)" },
  "settings.generateFeedUrl": { ru: "Создать ссылку", en: "Generate Feed URL" },
  "settings.regenerateFeedUrl": { ru: "Пересоздать", en: "Regenerate" },
  "settings.revokeFeedUrl": { ru: "Отключить", en: "Revoke" },
  ...
  "settings.comingSoon": { ru: "Скоро", en: "Coming soon" },
