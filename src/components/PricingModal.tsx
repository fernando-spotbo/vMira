...
export default function PricingModal({ onClose }: PricingModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className={`w-full max-w-[1100px] rounded-2xl bg-[#1a1a1a] border border-white/[0.06] shadow-[0_24px_80px_rgba(0,0,0,0.6)] overflow-hidden transition-all duration-250 ${
      ...
      >
        ...
        <div className="px-8 pb-6 text-center">
          <p className="text-[13px] text-white/40">{t("pricing.footer")}</p>
        </div>
      </div>
    </div>
  );
