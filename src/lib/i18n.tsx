...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "briefing.goodMorning": { ru: "Доброе утро", en: "Good morning" },
  "briefing.goodAfternoon": { ru: "Добрый день", en: "Good afternoon" },
  "briefing.goodEvening": { ru: "Добрый вечер", en: "Good evening" },
  "briefing.today": { ru: "Сегодня", en: "Today" },
  "briefing.noEvents": { ru: "Нет событий на сегодня", en: "No events today" },
  "briefing.reminders": { ru: "Напоминания", en: "Reminders" },
  "briefing.thisWeek": { ru: "На этой неделе", en: "This week" },
  "briefing.memories": { ru: "Воспоминания", en: "Memories" },
  "briefing.telegramDelivery": { ru: "Telegram доставка", en: "Telegram delivery" },
  "briefing.telegramDesc": { ru: "Получать обзор в Telegram каждое утро", en: "Receive briefing in Telegram every morning" },
  "briefing.deliveryTime": { ru: "Время", en: "Time" },
