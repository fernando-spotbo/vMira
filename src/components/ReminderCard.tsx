...
import { Ellipsis, Pencil, Trash2, Pause, Calendar, Bell, Send } from "lucide-react";
import { t } from "@/lib/i18n";
import { useChat } from "@/context/ChatContext";
import { deleteReminder, snoozeReminder, updateReminder } from "@/lib/api-client";
            ...
            {menuOpen && (
              <div className="absolute right-0 top-full z-50 mt-1 w-52 overflow-hidden rounded-xl border border-white/[0.08] bg-[#1e1e1e] py-1 shadow-[0_8px_30px_rgba(0,0,0,0.6)]">
                ...
                >
                  ...
                  <span className="flex-1 text-left">{hasTelegram ? "Убрать Telegram" : "Telegram"}</span>
